/**
 *  $Id: MSI.java,v 1.1.1.1 2004/01/15 15:56:02 dwalters Exp $ 
 *
...
public class MSI extends AbstractBarcodeStrategy implements java.io.Serializable {
  ...
  protected String augmentWithChecksum(String text) throws BarcodeException {
    ...
    newNum = Integer.toString(check1);
            //new Integer(check1).toString();
    int check2 = 0;
    ...
    text = text + Integer.toString(checkDigit);
            //new Integer(checkDigit).toString();
    return text;
  }
