...
public class AuthFilter implements Filter {
    ...
    private void forward(HttpServletRequest req, ServletResponse response) throws ServletException, IOException {
        req.setAttribute("target", "target");
        req.getSession().getServletContext().getRequestDispatcher("/index.jsf").forward(req, response);
    }
